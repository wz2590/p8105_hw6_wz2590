...
We are 95% confident that the true value of R_squared is in the interval [0.894, 0.927].
We are also 95% confident that the true value of log(beta_0 * beta_1) is in the interval [1.964, 2.059].
